...
public class WeatherController {
	...
	// Added for repeatable testing using fixed time
	private Date fakeDateForTest = null;
	...
	// Added for fake clock testing
	public void setFakeDateForTest(Date fakeDateForTest) {
		this.fakeDateForTest = fakeDateForTest;
	}
	...
	public String persistTemperature(int hour, double temperature) {
		...
		// Use fixed test time if available, otherwise use real current time
		Date dateToUse = (fakeDateForTest != null) ? fakeDateForTest : new Date();
